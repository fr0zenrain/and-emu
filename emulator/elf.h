...
typedef struct _plt_stub{
	unsigned int adr;
	unsigned int add;
	unsigned int ldr;
}plt_stub;

typedef struct _elf_obj_info
{
	unsigned char* data;
	unsigned int size;
	...
	unsigned char* elf_map_addr;
	unsigned int elf_map_size;
	unsigned char* elf_bss_addr;
	unsigned int elf_bss_size;
	plt_stub* elf_plt_addr;
	unsigned int plt_size;
	unsigned int* elf_got_addr;
